...
def main():
    ...
    for input_path in image_file_paths:
        ...
        output_path = os.path.join(
            ...
            THUMBNAIL_OUTPUT_PREXIF + os.path.basename(input_path),
        )
        ...
        try:
            ...
            size = [
                image.size[0] * THUMBNAIL_COMPRESSION_RATIO,
                image.size[1] * THUMBNAIL_COMPRESSION_RATIO,
            ]
            size = [
                min(max(dimension, MIN_DIMENSION_PIXELS), MAX_DIMENSION_PIXELS)
